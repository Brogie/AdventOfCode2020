...
namespace day1
{
    class Program
    {
        ...
        {
            foreach (var number1 in expenses)
            {
                int sumToFind = 2020 - number1;

                foreach (var number2 in expenses)
                {
                    if (number2 != number1)
                    {
                        foreach (var number3 in expenses)
                        {
                            if(number2 + number3 == sumToFind)
                            {
